...
<asp:Label runat="server" ID="ProductDropDown" CssClass="list-group">
     ...
     <div class="hvr-float">
      <div class="container">
    <img src="/WebImages/sulman.png" alt="SULAMAIN JAVED"/>
    <div class="overlay">SULAMAIN JAVED</div>
        </div>
   </div>

        <div class="hvr-float">
      <div class="container">
    <img src="/WebImages/rasaal.png" alt="RASAAL AHMED"/>
    <div class="overlay">RASAAL AHMED</div>
        </div>
   </div>
    ...
    <div class="overlay">JUNAID AFZAL</div>
        ...
        <div class="hvr-float">
      <div class="container">
    <img src="/WebImages/Avatar.jpg" alt="OMAMA KASHAN"/>
    <div class="overlay">OMAMA KASHAN</div>
        </div>
   </div>
